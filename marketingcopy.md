# SuperGP — marketing copy (verbatim snapshot)
...
## Pain points
- **Headline:** Stop running on spreadsheets. It's costing you more than you think! We have expereinced your frustrations first hand!

- **Pain point 1:** Your Rota Falls Apart Weekly
...
- **Pain point 2:** You're Not Audit-Ready
...
- **Pain point 3:** You're Leaving Appointments on the Table
...
**Headine**
- Built by People Who Get It (gradient span)
...
- **Bio:** A GP by trade, I currently run three clinics supporting over 10,000 patients. Having managed a team of 50+, I've lived the exact frustrations SuperGP is designed to solve.
- **Bio:** I act as Voice of the customer here, making sure every feature we build genuinely meets the shifting demands of the NHS and makes sense on the front lines.

### Tak Cheung
- **Role:** Product Director
- **Bio:** With over 12 years of experience building at scale for Amazon and BT, I now focus on transforming legacy sectors with modern digital solutions.
- **Bio:** At SuperGP, I lead product development; obsessing over the user experience to ensure The SuperGP app is as intuitive as it is powerful, ultimately making life easier for practice teams.

### Kazim Hussein
=
- **Role:** CTO
- **Bio:** Backed by 15 years in technology and consulting, I oversee the technical delivery of the platform.
- **Bio:** My focus is on ensuring SuperGP isn't just fast and responsive, but built on a secure, best-in-class infrastructure that practices can rely on 24/7.
...
### Benefit 1 
- **Benefit name** Less admin time
- **Headline** Cut Admin by 70%
- **Description:** Automate rotas, tasks, and compliance tracking so your team spends time on patients, not paperwork.

### Benefit 2
- **Benefit name:** 100% staffing visibility
- **Headline** Eliminate Staffing Blind Spots
- **Description:** See exactly who's working, where, and when — maximise patient throughput across every site.

### Benefit 3
- **Benefit name** 0 audit surprises
- **Headline:** Stay Audit-Ready, Always
- **Description:** Compliance data lives in one place, time-stamped and inspection-ready — no more last-minute scrambles.

### Benefit 4

- **Benefit name:** 1 system for all sites
- **Headline:** One System, Every Site
- **Description:** Manage multiple locations with different hours, rooms, and teams — all from a single dashboard.

### Benefit 5
- **Benefit name:** 24/7 reliable operations
- **Headlone:** Minimise Daily Disruptions
- **Description:** Reliable scheduling and automated task flows keep your practice running smoothly, every single day.
